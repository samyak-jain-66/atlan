...
function Card() {
  return (
    <div className="bg-white border-[1px] border-[lightgray] lg:w-[30%] w-[100%] h-[30rem] lg:h-[32.5rem] xl:h-[30rem] rounded-[15px] p-5 cursor-pointer hover:scale-110 transition duration-500 ease-in-out hover:shadow-md">
      <div className="flex flex-col">
        ...
        <p className="text-[15px] font-light mb-[40px]">
          Ideal for those who have already got their website up and running and
      ...
      <div className="mt-[1.25rem] sm:mt-[2rem] lg:mt-[1rem]">
