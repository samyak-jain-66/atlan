  ...
  return (
    ...
    >
      <div className='flex flex-col justify-center'>
        ...
        <button className='bg-[#0057A8] text-[#fff] text-[16px] py-[6px] px-4 rounded-md hover:opacity-85 mt-14 max-w-[120px] transition duration-500 ease-in-out hover:scale-125'>
          Get Started
        </button>
      </div>
      <div>
        <img
          src={feature}
          className='md:w-[500px] md:h-[580px] w-[350px] h-[300px]'
          alt='feature'
        />
      </div>
    </div>
