...
function Card() {
  return (
    <div className='bg-white border-[1px] border-[lightgray] md:w-[30%] w-[100%] h-[480px] rounded-[15px] p-5 cursor-pointer hover:scale-110 transition duration-500 ease-in-out hover:shadow-md'>
